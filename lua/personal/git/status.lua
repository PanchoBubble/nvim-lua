...
local function add_keymaps(window_buffer)
  vim.api.nvim_buf_set_keymap(window_buffer, "n", "c", "<cmd>BranchCommit<CR>", { noremap = true, silent = true })

  vim.api.nvim_buf_set_keymap(window_buffer, "n", "a", "<cmd>BranchAddAll<CR>", { noremap = true, silent = true })

  vim.api.nvim_buf_set_keymap(window_buffer, "n", "ra", "<cmd>BranchResetAll<CR>", { noremap = true, silent = true })

  vim.api.nvim_buf_set_keymap(
    window_buffer,
    "n",
    "s",
    "<cmd>BranchStashCurrentLine<CR>",
    { noremap = true, silent = true }
  )

  vim.api.nvim_buf_set_keymap(window_buffer, "n", "<s-S>", "<cmd>BranchStashAll<CR>", { noremap = true, silent = true })

  vim.api.nvim_buf_set_keymap(
    window_buffer,
    "n",
    "<leader>p",
    "<cmd>BranchStashPop<CR>",
    { noremap = true, silent = true }
  )

  vim.api.nvim_buf_set_keymap(window_buffer, "n", "<s-P>", "<cmd>BranchPush<CR>", { noremap = true, silent = true })

  vim.api.nvim_buf_set_keymap(window_buffer, "n", "<s-F>", "<cmd>BranchFetch<CR>", { noremap = true, silent = true })

  vim.api.nvim_buf_set_keymap(window_buffer, "n", "p", "<cmd>BranchPull<CR>", { noremap = true, silent = true })

  vim.api.nvim_buf_set_keymap(
    window_buffer,
    "n",
    "<leader>co",
    "<cmd>BranchCheckoutCurrentLine<CR>",
    { noremap = true, silent = true }
  )
  ...
  vim.api.nvim_buf_set_keymap(window_buffer, "n", "d", "<cmd>BranchDiffsplit<CR>", { noremap = true, silent = true })

  vim.api.nvim_buf_set_keymap(window_buffer, "n", "o", "<cmd>BranchOpenFile<CR>", { noremap = true, silent = true })

  vim.api.nvim_buf_set_keymap(
    window_buffer,
    "v",
    "<CR>",
    "<cmd>BranchFileToggleStaged<CR>",
    { noremap = true, silent = true }
  )
end
