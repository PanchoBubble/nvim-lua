...
local function add_buffer_keymaps()
  ...
  vim.api.nvim_buf_set_keymap(window_buffer, "n", "?", "<cmd>BranchDocs<CR>", { noremap = true, silent = true })

  -- Define action on <CR>
  local command = "<cmd>" .. active_tab.on_enter .. "<CR>"
  vim.api.nvim_buf_set_keymap(window_buffer, "n", "<CR>", command, { noremap = true, silent = true })
